...
function DeviceMotionSettings() {
  ...
  const handleCheck = ()=> {
    ...
    checkAvail();
    console.log("Check values x=" + data.acceleration.x + " y=" + data.acceleration.y + " z= "+ data.acceleration.z);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.heading}>Acceleration Including Gravity </Text>
      ...
      <Text style={styles.heading}>Interval : {data.interval}</Text>
      ...
      <Text style={styles.heading}>Rotation Rate</Text>
